...
const App = () => {
    ...
    // Public pages with their own layout (header/footer)
    ...
    return (
        <>
            {profileRoute ? (
                // ProfilePage has its own sidebar
                <Routes>
                    <Route path="/ProfilePage" element={<ProfilePage />} />
                </Routes>
            ) : isPublicFullPage ? (
                // Full-width public pages with header/footer
                <Routes>
                    <Route path="/workouts" element={<Workouts />} />
                </Routes>
            ) : fullWidthRoutes ? (
                // Full-width layout for routine detail/edit pages
                <Routes>
